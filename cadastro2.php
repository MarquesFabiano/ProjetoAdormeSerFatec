  ...
  <div class="container">
    <main class="d-flex flex-wrap justify-content-center">
      <div class="py-5 text-center txtcor1">
        ...
        <p class="lead bgcor6">Agora falta pouco para descobrir as vantagens de ter um sono melhor!</p>
      </div>
      <div class="col-md-7 col-lg-8 txtcor1">
        <h4 class="mb-3 text-center">Informe seus dados para cadastro</h4>
        <br>
        <form class="needs-validation" novalidate action="php/processa_dados.php" method="POST">
          <div class="row g-3">
            <div class="col-sm-4">
              <label for="Idade" class="form-label">Idade</label>
              <input type="date" class="form-control" id="Idade" name="idade" placeholder="Informe sua idade" required>
            ...
            <div class="col-sm-4">
              ...
              <input type="time" class="form-control" id="Dormir" name="horario_dormir" placeholder="Horário de Dormir"
                required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-4">
              ...
              <input type="time" class="form-control" id="Acordar" name="horario_acordar"
                placeholder="Horário de Acordar" required>
              <div class="invalid-feedback">
          ...
          <br>
          <button class="btn-primeiro w-100" type="submit">Finalizar</button>
        </form>
      </div>
  </div>
  </main>
